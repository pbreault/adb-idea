...
import io.github.raghavsatyadev.adbidea.preference.accessor.InMemoryPreferenceAccessor
...
class UseSameDevicesHelperTest {
  ...
  private fun ProjectPreferences.willReturn(vararg ids: String) =
    saveSelectedDeviceSerials(ids.asList())
}
