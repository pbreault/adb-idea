package io.github.raghavsatyadev.adbidea.debugger
...
import io.github.raghavsatyadev.adbidea.on
import io.github.raghavsatyadev.adbidea.waitUntil
...
class Debugger(
  ...
  private fun closeOldSessionAndRun(
    androidDebugger: AndroidDebugger<AndroidDebuggerState>,
    client: Client,
  ) {
...
class TerminateRunSession(private val selectedClient: Client, private val project: Project) :
...
private class RunningProcessesGetter(val project: Project) :
