...
object NotificationHelper {
     val INFO = NotificationGroup.logOnlyGroup("ADB Idea (Logging)")
     val ERRORS = NotificationGroup.balloonGroup("ADB Idea (Errors)")
     val NOOP_LISTENER = NotificationListener { _: Notification?, _: HyperlinkEvent? -> }
